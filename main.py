...
#train_networks.train_cluster_net(epoch=5000, plot_result=False, backup_name="cluster_net_three", batch_size=4096)
#train_networks.train_cluster_net(epoch=6000, plot_result=False, backup_name="cluster_net_three", batch_size=16384)
